...
const Home = () => {
  ...
  return (
    <section
    ref={ref} className="px-8 md:px-[8%] w-full h-[90vh] bg-[var(--bg-color)] text-[var(--text-color)] text-center md:text-left flex items-center justify-center md:justify-start relative">
      <div className="max-w-[35rem] py-2">
        ...
        <p className="pb-4 relative">
          ...
          ex veritatis, quidem repudiandae at, maiores saepe praesentium ratione
          cum nihil numquam, exercitationem aut incidunt vitae. Perferendis
          impedit mollitia vel saepe.
