...
const MyJOurney = () => {
  ...
  return (
    <section
      ref={ref}
      className="px-8 md:px-[8%] py-[8%] w-full h-[90vh] bg-[var(--bg-color)] text-[var(--text-color)] "
    >
      <h2 className="relative w-fit m-auto text-center text-4xl font-bold text-[var(--text-color)] py-1">
